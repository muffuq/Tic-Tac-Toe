...
},{"gsap":"../node_modules/gsap/index.js","./utils":"js/utils.js"}],"../node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
var Slide = /*#__PURE__*/_createClass(function Slide(el) {
  _classCallCheck(this, Slide);
  this.DOM = {
    el: el
  };
  this.DOM.chars = this.DOM.el.querySelectorAll('.slide__title .word > .char, .whitespace');
  this.DOM.imgs = this.DOM.el.querySelectorAll('.slide__img');
  this.DOM.ps = this.DOM.el.querySelector('.slide__p');
});
...
function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return _typeof(key) === "symbol" ? key : String(key); }
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
var slid_p = document.querySelector('.slide__p');
    ...
    value: function navigate(direction) {
      ...
      _gsap.gsap.timeline({
        ...
        onComplete: function onComplete() {
          ...
          console.log(currentSlide.DOM);
        }
      }).to(currentSlide.DOM.ps, {
        opacity: 0,
        y: direction === "next" ? 100 : -100,
        duration: 1,
        ease: 'power4.inOut'
      }, "start", 0).addLabel('start', 0)
      ...
      .to(currentSlide.DOM.imgs, {
        ...
        _gsap.gsap.set(nextSlide.DOM.ps, {
          y: direction === "next" ? -100 : 100,
          opacity: 0
        });
        // Add "current" class
        nextSlide.DOM.el.classList.add('slide--current');
      }, 'upcoming').to(nextSlide.DOM.ps, {
        opacity: 1,
        y: 0,
        duration: 1,
        ease: 'power4.inOut'
...
},{"../cursor":"js/cursor.js","./slideshow":"js/demo1/slideshow.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
